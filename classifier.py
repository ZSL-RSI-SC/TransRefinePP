...
class CLASSIFIER:
    ...
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5,
        ...
        if self.netFR:
            ...
            #scipy.io.savemat('test_seen_and_unseen_features_PoFE.mat', {'test_unseen_features':test_unseen_feature, 'test_seen_features':test_seen_feature})
        ...
        #scipy.io.savemat('test_unseen_feature_PoFE.mat', {'test_unseen_features':self.test_unseen_feature, 'test_unseen_labels':self.test_unseen_label})
